namespace SinerjiCRM
{
    partial class SatisTeklif
    {
        ...
        private void InitializeComponent()
        {
            ...
            txtDovizTip = new TextBox();
            txtResimYolu = new TextBox();
            label42 = new Label();
            label40 = new Label();
            btnResimEkle = new Button();
            txtVadeGunu = new TextBox();
            label41 = new Label();
            txtVadeTarihi = new TextBox();
            label39 = new Label();
            txtGenelToplam = new TextBox();
            label33 = new Label();
            txtKdvToplami = new TextBox();
            label31 = new Label();
            txtKdvOrani = new TextBox();
            label32 = new Label();
            txtBrutToplam = new TextBox();
            label5 = new Label();
            txtHazirlayan = new TextBox();
            label6 = new Label();
            txtPaketleme = new TextBox();
            label8 = new Label();
            txtGecerlilik = new TextBox();
            label12 = new Label();
            txtOdemeSartlari = new TextBox();
            label23 = new Label();
            txtNakliyeSarti = new TextBox();
            label22 = new Label();
            txtIstenenOzellikler = new TextBox();
            button2 = new Button();
            txtSatisMuhendisi = new TextBox();
            label21 = new Label();
            button1 = new Button();
            txtFirmaTemsilcisi = new TextBox();
            label20 = new Label();
            label19 = new Label();
            txtTeklifDurumu = new TextBox();
            label18 = new Label();
            rbYurtDisi = new RadioButton();
            rbYurtIci = new RadioButton();
            label13 = new Label();
            txtDovizBazTarihi = new TextBox();
            btnCariKod = new Button();
            label4 = new Label();
            cmbIthalatIhracat = new ComboBox();
            label11 = new Label();
            ...
            panel1.Controls.Add(txtDovizTip);
            panel1.Controls.Add(txtResimYolu);
            panel1.Controls.Add(label42);
            panel1.Controls.Add(label40);
            panel1.Controls.Add(btnResimEkle);
            panel1.Controls.Add(txtVadeGunu);
            panel1.Controls.Add(label41);
            panel1.Controls.Add(txtVadeTarihi);
            panel1.Controls.Add(label39);
            panel1.Controls.Add(txtGenelToplam);
            panel1.Controls.Add(label33);
            panel1.Controls.Add(txtKdvToplami);
            panel1.Controls.Add(label31);
            panel1.Controls.Add(txtKdvOrani);
            panel1.Controls.Add(label32);
            panel1.Controls.Add(txtBrutToplam);
            panel1.Controls.Add(label5);
            panel1.Controls.Add(txtHazirlayan);
            panel1.Controls.Add(label6);
            panel1.Controls.Add(txtPaketleme);
            panel1.Controls.Add(label8);
            panel1.Controls.Add(txtGecerlilik);
            panel1.Controls.Add(label12);
            panel1.Controls.Add(txtOdemeSartlari);
            panel1.Controls.Add(label23);
            panel1.Controls.Add(txtNakliyeSarti);
            panel1.Controls.Add(label22);
            panel1.Controls.Add(txtIstenenOzellikler);
            panel1.Controls.Add(button2);
            panel1.Controls.Add(txtSatisMuhendisi);
            panel1.Controls.Add(label21);
            panel1.Controls.Add(button1);
            panel1.Controls.Add(txtFirmaTemsilcisi);
            panel1.Controls.Add(label20);
            panel1.Controls.Add(label19);
            panel1.Controls.Add(txtTeklifDurumu);
            panel1.Controls.Add(label18);
            panel1.Controls.Add(rbYurtDisi);
            panel1.Controls.Add(rbYurtIci);
            panel1.Controls.Add(label13);
            panel1.Controls.Add(txtDovizBazTarihi);
            panel1.Controls.Add(btnCariKod);
            ...
            panel1.Controls.Add(cmbIthalatIhracat);
            panel1.Controls.Add(txtTarih);
            panel1.Controls.Add(txtNo);
            panel1.Controls.Add(btnAktar);
            panel1.Controls.Add(label17);
            panel1.Controls.Add(txtNot4);
            panel1.Controls.Add(label16);
            panel1.Controls.Add(txtNot3);
            panel1.Controls.Add(btnSil);
            panel1.Controls.Add(label15);
            panel1.Controls.Add(btnGeri);
            panel1.Controls.Add(txtNot2);
            panel1.Controls.Add(label11);
            panel1.Controls.Add(label14);
            panel1.Controls.Add(txtNot1);
            ...
            label40.TabIndex = 171;
            label40.Text = "Vade Günü";
            // 
            // btnResimEkle
            // 
            ...
            label41.TabIndex = 170;
            label41.Text = "Vade Tarihi";
            // 
            // txtVadeTarihi
            // 
            ...
            label39.Size = new Size(83, 15);
            label39.TabIndex = 167;
            label39.Text = "Genel Toplam";
            // 
            // txtGenelToplam
            // 
            ...
            label32.TabIndex = 150;
            label32.Text = "Brüt Toplam";
            // 
            // txtBrutToplam
            // 
            ...
            label22.Text = "İstenen Özellikler";
            // 
            ...
            rbYurtDisi.Location = new Point(82, 148);
            rbYurtDisi.Name = "rbYurtDisi";
            rbYurtDisi.Size = new Size(88, 19);
            rbYurtDisi.TabIndex = 103;
            rbYurtDisi.TabStop = true;
            rbYurtDisi.Text = "/    Yurt Dışı";
            rbYurtDisi.UseVisualStyleBackColor = true;
            // 
            // rbYurtIci
            // 
            ...
            rbYurtIci.Location = new Point(12, 147);
            rbYurtIci.Name = "rbYurtIci";
            rbYurtIci.Size = new Size(64, 19);
            rbYurtIci.TabIndex = 102;
            rbYurtIci.TabStop = true;
            rbYurtIci.Text = "Yurt İçi";
            rbYurtIci.UseVisualStyleBackColor = true;
            // 
            // label13
            // 
            ...
            btnCariKod.TabIndex = 95;
            btnCariKod.UseVisualStyleBackColor = true;
            // 
            // label4
            // 
            ...
            label4.TabIndex = 8;
            label4.Text = "İthalat / İhracat Tipi";
            // 
            // cmbIthalatIhracat
            // 
        ...
        private TextBox txtDovizBazTarihi;
        private Button btnCariKod;
        private RadioButton rbYurtDisi;
        private RadioButton rbYurtIci;
        private Button button2;
        private TextBox txtSatisMuhendisi;
        private Label label21;
        private Button button1;
        private TextBox txtFirmaTemsilcisi;
        private Label label20;
        private Label label19;
        private TextBox txtTeklifDurumu;
        private Label label18;
        private Label label23;
        private TextBox txtNakliyeSarti;
        private Label label22;
        private TextBox txtIstenenOzellikler;
        private Label label4;
        private ComboBox cmbIthalatIhracat;
        private Label label11;
        private Label label5;
        private TextBox txtHazirlayan;
        private Label label6;
        private TextBox txtPaketleme;
        private Label label8;
        private TextBox txtGecerlilik;
        private Label label12;
        private TextBox txtOdemeSartlari;
        private Label label31;
        private TextBox txtKdvOrani;
        private Label label33;
        private TextBox txtKdvToplami;
        private Label label40;
        private TextBox txtVadeGunu;
        private Label label41;
        private TextBox txtVadeTarihi;
        ...
        private TextBox txtBrutToplam;
        private TextBox txtDovizTip;
