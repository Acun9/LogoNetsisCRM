...
namespace SinerjiPanel
{
    public partial class CariKayit : Form
    {
        ...
        private void btnAktar_Click(object sender, EventArgs e)
        {
            ...
            // NetOpenX için şirket tanımlama
            Kernel kernel = new Kernel();
            Sirket sourceSirket = kernel.yeniSirket(TVTTipi.vtMSSQL, "SINERJICRM", "sa", "SA123pass_", "netsis", "5091", 0);
            Sirket destinationSirket = kernel.yeniSirket(TVTTipi.vtMSSQL, "SINERJISMART", "TEMELSET", "", "netsis", "5091", 0);
            ...
            {
                // NetOpenX belleğini temizle (tanımladığımız nesneleri sondan başa doğru temizleriz)
